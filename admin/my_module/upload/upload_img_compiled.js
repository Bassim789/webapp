	...
	_createClass(_class, [{
		...
		value: function set_html() {
			...
			$('[event="click:change_image"]').each(function () {
				...
				form.html(input);
				el.attr('src', el.data('url')).after(form).after(progress);
			});
		}
	}, {
		key: 'change_image',
		value: function change_image(elem) {
		...
		key: 'file_upload',
		value: function file_upload(elem) {
			var that = this,
